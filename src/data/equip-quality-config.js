...
function createEquipQualityMeta(config) {
  return {
    ...
    economy: {
      ...
      gradeSellMultiplier: config.gradeSellMultiplier,
...
window.__JH_DATA__.equipQualityConfig = {
  ...
  common: createEquipQualityMeta({
    ...
    baseValueMultiplier: 1.0, sellMultiplier: 0.22, gradeSellMultiplier: 1.0, salvageMultiplier: 0.30,
  ...
  fine: createEquipQualityMeta({
    ...
    baseValueMultiplier: 1.3, sellMultiplier: 0.24, gradeSellMultiplier: 1.25, salvageMultiplier: 0.35,
  ...
  rare: createEquipQualityMeta({
    ...
    baseValueMultiplier: 1.8, sellMultiplier: 0.27, gradeSellMultiplier: 1.6, salvageMultiplier: 0.42,
  ...
  epic: createEquipQualityMeta({
    ...
    baseValueMultiplier: 2.5, sellMultiplier: 0.30, gradeSellMultiplier: 2.2, salvageMultiplier: 0.50,
  ...
  legend: createEquipQualityMeta({
    ...
    baseValueMultiplier: 3.4, sellMultiplier: 0.34, gradeSellMultiplier: 3.0, salvageMultiplier: 0.58,
